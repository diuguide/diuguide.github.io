            ...
            <div className="row coverDiv">
              <div className="col description">
                <div className="descriptionText">
                  A MERN stack 3rd party API application gathering the current
                  and five-day forecast for a selected city, allowing users to
                  create individualized settings and save search data
                </div>
              </div>
            </div>
